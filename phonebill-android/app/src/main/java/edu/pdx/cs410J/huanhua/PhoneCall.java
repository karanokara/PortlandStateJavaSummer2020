...
public class PhoneCall extends AbstractPhoneCall implements Comparable<PhoneCall> {
    ...
    private String validateTime(String dateTime) throws IllegalArgumentException {
        ...
        if (dateStr.length != 3) {
            throw new IllegalArgumentException("Invalid format of date argument: " + date);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid month argument: " + m);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid day argument: " + d);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid year argument: " + y);
        }
        ...
        if (timeStr.length != 2) {
            throw new IllegalArgumentException("Invalid format of time argument: " + time);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid hour argument: " + h);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid minute argument: " + mi);
        }
