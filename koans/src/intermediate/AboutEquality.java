...
public class AboutEquality {
	...
	public void noObjectShouldBeEqualToNull() {
		assertEquals(new Object().equals(null), false);		// already allocated, not a null pointer
	}
	...
	static class Car {
		...
		public boolean equals(Object other) {
			...
			try {
				...
				return this.name.equals(otherCar.name) && this.horsepower == otherCar.horsepower;
			}
			catch (Exception e) {
				return false;
			}
...
//			return this.hashCode();
			return this.name.hashCode() + this.horsepower;
		}
	}
	...
	public void ownHashCode() {
		// As a general rule: When you override equals you should override hash code
...
//			return 4000;
	...
	public void ownHashCodeImplementationPartTwo() {
		...
		// Does this still fit the hashCode contract? Why (not)? No, equals() <==> hashCode()
