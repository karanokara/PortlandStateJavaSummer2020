...
public class AboutInnerClasses {
	...
	public void creatingAnonymousInnerClassesToImplementInterface() {
		...
		// Did you just created an object of an interface type? No
	...
	public void innerClassAndInheritance() {
		...
		// Incompatible conditional operand types AboutInnerClasses.Inner and AboutInnerClasses
	...
	public void innerClassAndInheritanceOther() {
		...
		// inner class is member of that class, instead of "instanceof"
