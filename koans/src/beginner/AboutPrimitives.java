...
public class AboutPrimitives {
	...
	public void wholeNumbersAreOfTypeInt() {
		assertEquals(getType(1), int.class); // // primitive class print out: int
	}
	
	@Koan
	public void primitivesOfTypeIntHaveAnObjectTypeInteger() {
		Object number = 1;
		assertEquals(getType(number), Integer.class);	// object class print out: class java.lang.Integer
	...
	public void wholeNumbersCanAlsoBeOfTypeLong() {
		assertEquals(getType(1L), long.class);		// primitive class print out: long
	}
	...
	public void charsCanOnlyBePositive() {
		...
		// then need to put a character, not real possible to input it
	}
